...
const en: Dict = {
  ...
  auth: {
    ...
    signupCheckEmail: "Account created! Click the link in your email to confirm your address — you'll be signed in and taken to your dashboard automatically.",
...
const fr: Dict = {
  ...
  auth: {
    ...
    signupCheckEmail: "Compte créé ! Cliquez sur le lien dans votre e-mail pour confirmer votre adresse — vous serez connecté et redirigé vers votre tableau de bord automatiquement.",
...
const de: Dict = {
  ...
  auth: {
    ...
    signupCheckEmail: "Konto erstellt! Klicken Sie auf den Link in Ihrer E-Mail, um Ihre Adresse zu bestätigen — Sie werden automatisch angemeldet und zu Ihrem Dashboard weitergeleitet.",
